...
if(loadingInitial) return <LoadingComponent content="Loading activity..."></LoadingComponent>
    return (
        <Segment clearing>
            <Formik enable initialValues={activity} onSubmit={values => console.log(values)}>
            ...
            <Form.Input placeholder='Date' type="date"  value={activity.date} name='date' onChange={handleChange}></Form.Input>
