...
if(loadingInitial) return <LoadingComponent content="Loading activity..."></LoadingComponent>
    return (
        <Segment clearing>
            ...
            <Field placeholder='Category'  value={activity.category} name='category' onChange={handleChange}></Field>
            <Field placeholder='Date' type="date"  value={activity.date} name='date' onChange={handleChange}></Field>
            <Field placeholder='City'  value={activity.city} name='city' onChange={handleChange}></Field>
            <Field placeholder='Venue'  value={activity.venue} name='venue' onChange={handleChange}></Field>
