...
if(loadingInitial) return <LoadingComponent content="Loading activity..."></LoadingComponent>
    return (
        <Segment clearing>
            ...
            <MyTextInput placeholder='Category'  name='category'></Field>
            <MyTextInput placeholder='Date' type="date"  name='date'></Field>
            <MyTextInput placeholder='City' name='city'></Field>
            <MyTextInput placeholder='Venue'  name='venue'></Field>
